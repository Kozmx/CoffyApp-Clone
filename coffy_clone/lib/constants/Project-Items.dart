...
class ColorItems {
  static final Color brightGrey = Color(0xFFF4F5F7);
  static final Color blackcolor = Colors.black;
  static final Color whitecolor = Colors.white;
  static final Color orangecolor = Color(0xFFF7941D);

}

class PaddingItems {
  static const EdgeInsets symmetricPadding = EdgeInsets.symmetric(horizontal: 15, vertical: 8);
